...
//
//            .addState( new StateCounterState( "broken 4-5-8", "broken 4-5-8 [E] Sq", "ru/rus8b"))
//            .addState( new StateCounterState( "broken 4-4-7", "broken 4-4-7 [1] Sq", "ru/rus7b"))
//            .addState( new StateCounterState( "broken 4-2-6", "broken 4-2-6 C Sq", "ru/rus5b"))
//            .addState( new StateCounterState( "broken 5-2-7", "broken 5-2-7 1 Sq", "ru/rus7b"))
//            .addState( new StateCounterState( "broken 6-2-8", "broken 6-2-8 (E) Sq", "ru/rus8b"))
//            .addState( new StateCounterState( "broken 2-4-8", "broken 2-4-8 [E] Hs", "ru/ruh7b"))
//            .addState( new StateCounterState( "broken 2-3-7", "broken 2-3-7 [1] Hs", "ru/ruh6b"))
//            .addState( new StateCounterState( "broken 2-2-6", "broken 2-2-6 C Hs", "ru/ruh4b"))
//            .addState( new StateCounterState( "broken 2-2-7", "broken 2-2-7 1 Hs", "ru/ruh6b"))
//            .addState( new StateCounterState( "broken 3-2-8", "broken 3-2-8 (E) Hs", "ru/ruh7b"));
//
...
//        System.out.println("hardCodeInitialize end");
    ...
    public StateCounter() {
        this( ID + "{\"states\":[],\"keyToCommandMap\":[]}", null );
    }
    ...
    public void draw(Graphics g, int x, int y, Component obs, double zoom) {
        ...
        ScaledImagePainter painter = _stateCounterComposite.getScaledImagePainter();
        if ( painter != null ) {
    ...
    private Rectangle getCurrentImageBounds() {
        ...
        return this._stateCounterComposite.getCurrentImageBounds();
    }
    ...
    public String getName( boolean localized ) {
        return _stateCounterComposite.getName(localized);
    }
    ...
    public void mySetType(String type) {
        ...
        // strip the prefix
        String initializationJSON = type.substring(this.ID.length());
        _stateCounterComposite.initialize(initializationJSON);
    }
    ...
    public void mySetState(String newState) {
        ...
        _stateCounterComposite.mySetState( st.nextToken(null) );
    }

    @Override
    public String myGetState() {
        final SequenceEncoder se = new SequenceEncoder(';');
        return se.append(_stateCounterComposite.myGetState()).getValue();
    ...
    public Command myKeyEvent(KeyStroke stroke) {
        ...
        _stateCounterComposite.myKeyEvent(stroke);
